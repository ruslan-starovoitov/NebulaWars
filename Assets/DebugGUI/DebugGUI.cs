...
public class DebugGUI : MonoBehaviour
{
    ...
    [SerializeField] Color backgroundColor = new Color(0f, 0f, 0f, 0.2f);

    [Header("Runtime Debugging Only")] [SerializeField]
    ...
    {
        if (LogsEnabled){ Instance.InstanceLog(message.ToString());}
