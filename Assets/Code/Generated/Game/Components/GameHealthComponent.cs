...
public partial class GameEntity {
    ...
    public Code.Scenes.BattleScene.ECS.Components.HealthComponent health { get { return (Code.Scenes.BattleScene.ECS.Components.HealthComponent)GetComponent(GameComponentsLookup.Health); } }
    ...
    public void AddHealth(int newValue) {
        ...
        var component = (Code.Scenes.BattleScene.ECS.Components.HealthComponent)CreateComponent(index, typeof(Code.Scenes.BattleScene.ECS.Components.HealthComponent));
